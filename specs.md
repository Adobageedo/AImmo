...
Permissions par :
module (Documents, Dashboard…)
type de donnée (baux, propriétés) [NON-MVP]
Sécurité & conformité
...
3️⃣ Documents (Gestion documentaire)
...
3.4 Indexation et recherche
Indexation plein texte [MVP]
Recherche par nom, type, tags [MVP]
Filtres avancés [NON-MVP]
